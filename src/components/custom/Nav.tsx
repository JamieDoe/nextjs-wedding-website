...
import { Drawer, DrawerTrigger, DrawerContent, DrawerClose, buttonVariants } from '@/components'
...
export default function NavBar() {
  ...
  return (
    <header className={`absolute w-full top-0 z-50 pt-2 font-lovelace ${pathname?.includes('rsvp') && 'hidden'}`}>
